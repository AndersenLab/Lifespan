---
title: "NemaScan Report for t97_mean"
...
processed_mapping <- read.delim("processed_t97_mean_AGGREGATE_mapping.tsv", stringsAsFactors=FALSE) %>%
...
for (i in seq_len(nrow(QTL_peaks))) { 
    ...
    out <- c(out, knitr::knit_child('NemaScan_Report_region_t97_mean.Rmd'))
}
